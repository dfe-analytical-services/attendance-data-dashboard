...
# Data manipulation ----------------------------------------------------------------------------
# Read in data
attendance_data_raw <- fread("data/sql_export_2023_03_21.csv")
pa_data_raw <- fread("data/export_pa_output_2023_03_21.csv")
...
autumn_only_pa_data_raw <- fread("data/export_autumn_pa_output_2023_03_21.csv")
