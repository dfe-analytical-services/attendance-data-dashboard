    ...
    htmltools::tags$div(
      ...
      htmltools::tags$div(
        ...
        tags$p(
          ...
          " - ",
          tags$a(href = "https://department-for-education.shinyapps.io/pupil-attendance-in-schools-mirror-2", "Mirror b"),
          " - ",
          tags$a(href = "https://department-for-education.shinyapps.io/pupil-attendance-in-schools", "Mirror c")),
