            ...
            div(
              ...
              div(
                ...
                tags$div(
                  ...
                  p("This number is approximately 60% of the number of schools participating in the School Census. As schools opt in to sharing of data, the number of schools reporting may change over time. This figure is lower than in previous weeks due to some schools observing half term in the week commencing 19 February."),
