            ...
            div(
              ...
              div(
                ...
                tags$div(
                  ...
                  p("This number is approximately 67% of the number of schools participating in the School Census. As schools opt in to sharing of data, the number of schools reporting may change over time."),
                  ...
                  textOutput("homepage_weekly_dates"),
