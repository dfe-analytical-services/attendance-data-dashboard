...
process_attendance_data <- function(df_attendance_raw){
...
create_ees_tables <- function(df_attendance){
  ...
  EES_daily_data[is.na(EES_daily_data)]<-"z"
  ...
  EES_weekly_data[is.na(EES_weekly_data)]<-"z"
