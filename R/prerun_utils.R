run_data_update <- function(){
  ...
  pa_fullyear_file <- "data/export_pa_output_2023_05_16.csv"
  pa_autumn_file <- "data/export_autumn_pa_output_2023_05_16.csv"
  pa_spring_file <- "data/export_spring_pa_output_2023_05_16.csv"
  attendance_data_raw <- fread("data/sql_export_2023_05_16.csv")
